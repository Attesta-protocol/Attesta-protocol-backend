...
GET  /v1/notes/stream?pool=              → SSE, event: note (id: = cursor),
                                             ...
                                             ?pool= filters to one or more pools
                                             (comma-separated); cursor stays
                                             global, so switching pools across
                                             reconnects is still gap-free.
